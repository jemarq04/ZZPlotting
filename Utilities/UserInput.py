...
def getDefaultParser():
    ...
    parser.add_argument("--stat_file", type=str, default="", help="Read histograms from file")
    parser.add_argument(
        "--rebin",
    ...
    parser.add_argument("--extra_text", type=str, default="", help="Extra text to be added below (above) the legend")
    ...
    parser.add_argument("--stack_signal", action="store_true", help="Stack signal hists on top of background")
    parser.add_argument(
        "--exclude_from_sigstack",
        type=str,
        help="backgrounds to exclude when making signal stacks. Names separated by commas",
    )
    ...
    parser.add_argument("--logx", action="store_true", help="Use logaritmic scale on X-axis")
    parser.add_argument(
        "-c",
        "--channels",
        type=str,
