filename="Hists10Jul2024-ZZ4l2018_MVA.root" #Signal + Bgk + LHE + IDs (all coeffs + SMlimit + SM) eemm - 100K
...
options="-s ZZ4l2018/$selection -l 59.7 -u stat --no_data --no_ratio --latex --hist_file $VVAnalysis_path/HistFiles/$filename --preliminary --scaleymax 1.2 --scalelegx 1.5 --lhe_weight_id 0.0"

params="qqZ0Z0 qqZTZT"

for param in $params; do
  filelist="ZZEFT_${param}_nobkg"
  dir="${param}/eemm"
